...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BookUploadLog'
        db.create_table(u'bookrepo_bookuploadlog', (
        ...
        db.send_create_signal(u'bookrepo', ['BookUploadLog'])


    def backwards(self, orm):
        # Deleting model 'BookUploadLog'
        db.delete_table(u'bookrepo_bookuploadlog')
