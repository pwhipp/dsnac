...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Book.reference'
        db.alter_column(u'bookrepo_book', 'reference', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Book.identifier'
        db.alter_column(u'bookrepo_book', 'identifier', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Book.reference'
        db.alter_column(u'bookrepo_book', 'reference', self.gf('django.db.models.fields.CharField')(max_length=16, null=True))

        # Changing field 'Book.identifier'
        db.alter_column(u'bookrepo_book', 'identifier', self.gf('django.db.models.fields.CharField')(max_length=32, unique=True))
