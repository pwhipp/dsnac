...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Book.scanned_start_page'
        db.add_column(u'bookrepo_book', 'scanned_start_page',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.scanned_start_page'
        db.delete_column(u'bookrepo_book', 'scanned_start_page')
