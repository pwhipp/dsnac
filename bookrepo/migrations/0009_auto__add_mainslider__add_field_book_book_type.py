...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bookrepo_mainslider', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('image', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('annotation', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal(u'bookrepo', ['MainSlider'])

        # Adding field 'Book.book_type'
        db.add_column(u'bookrepo_book', 'book_type',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'bookrepo_mainslider')

        # Deleting field 'Book.book_type'
        db.delete_column(u'bookrepo_book', 'book_type')
