...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'userprofile_profile', 'first_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Profile.last_name'
        db.add_column(u'userprofile_profile', 'last_name',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'userprofile_profile', 'first_name')

        # Deleting field 'Profile.last_name'
        db.delete_column(u'userprofile_profile', 'last_name')
