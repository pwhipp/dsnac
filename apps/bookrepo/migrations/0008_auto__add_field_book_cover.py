...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bookrepo_book', 'cover',
                      self.gf('django.db.models.fields.files.FileField')(default='no_cover.jpg', max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.cover'
        db.delete_column(u'bookrepo_book', 'cover')
    ...
    models = {
        u'bookrepo.book': {
            ...
            'cover': ('django.db.models.fields.files.FileField', [], {'default': "'no_cover.jpg'", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
