...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'bookrepo_book', 'subject',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bookrepo.Subject'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Book.subject'
        db.delete_column(u'bookrepo_book', 'subject_id')
