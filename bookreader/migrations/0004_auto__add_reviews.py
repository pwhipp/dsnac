...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'bookreader_reviews', (
            ...
            ('review', self.gf('django.db.models.fields.TextField')(default=0)),
            ('headline', self.gf('django.db.models.fields.CharField')(default=0, max_length=255)),
        ))
        db.send_create_signal(u'bookreader', ['Reviews'])


    def backwards(self, orm):
        # Deleting model 'Reviews'
        db.delete_table(u'bookreader_reviews')
    ...
    models = {
        ...
        u'bookreader.reviews': {
            'Meta': {'object_name': 'Reviews'},
            'added': ('django.db.models.fields.DateField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'book_identifier': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['bookrepo.Book']"}),
            'headline': ('django.db.models.fields.CharField', [], {'default': '0', 'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'rating': ('django.db.models.fields.IntegerField', [], {}),
            'review': ('django.db.models.fields.TextField', [], {'default': '0'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        },
