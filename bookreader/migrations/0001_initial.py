...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BookReading'
        db.create_table(u'bookreader_bookreading', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('book_identifier', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bookrepo.Book'])),
            ('added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'bookreader', ['BookReading'])

        # Adding model 'BookHistory'
        db.create_table(u'bookreader_bookhistory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('book_identifier', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bookrepo.Book'])),
            ('added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'bookreader', ['BookHistory'])

        # Adding model 'FavoriteBook'
        db.create_table(u'bookreader_favoritebook', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('book_identifier', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['bookrepo.Book'])),
            ('added', self.gf('django.db.models.fields.DateField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'bookreader', ['FavoriteBook'])


    def backwards(self, orm):
        # Deleting model 'BookReading'
        db.delete_table(u'bookreader_bookreading')

        # Deleting model 'BookHistory'
        db.delete_table(u'bookreader_bookhistory')

        # Deleting model 'FavoriteBook'
        db.delete_table(u'bookreader_favoritebook')
